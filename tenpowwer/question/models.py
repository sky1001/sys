...
class Label(models.Model):
    ...
    label_icon = models.ImageField(null=True, default=None, verbose_name="标签图 片") # 标签的关注者
...
class Question(models.Model):
    ...
    useful_count = models.BigIntegerField(null=True, default=0, verbose_name="有 用数")
    #活动模块
