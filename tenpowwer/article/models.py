...
class Article(models.Model):
    ...
    comment_count = models.IntegerField(null=True, default=0, verbose_name="评论 数")
...
class Comment(models.Model):
    content = models.CharField(max_length=1000,default='', verbose_name='回答内 容')
    createtime = models.DateTimeField(auto_now_add=True, null=True, verbose_name="创建日期")
    ...
    class Meta: db_table = "article_comment"
